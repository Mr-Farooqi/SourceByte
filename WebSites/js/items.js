...
document.getElementById('card-0').addEventListener('click', function() {
  // Replace "https://website1.com" with the URL you want to open
  window.location.href = "https://calculator.mrfarooqi.repl.co/";
});

// CARDS-2 
document.getElementById('card-2').addEventListener('click', function() {
  // Replace "https://website1.com" with the URL you want to open
  window.location.href = "https://mr-farooqi.github.io/Diwali-Special/";
});
